...
function displayPics(){
  ...
  // rando is only usable from the block where it was declared, which in this case is the while loop. That console log was called outside the while loop, meaning rando no longer existed.
  console.log(viewed)
